 ...
 *  </p>
 *  <p>
 *  <strong>Important:</strong> this implementation of StdDraw is not the same as the one that is linked above.
 *  We added the possibility to register {@link java.awt.event.KeyListener}, {@link java.awt.event.MouseListener} and
 *  {@link java.awt.event.MouseMotionListener} to handle the appropriate events directly instead of relying on the
 *  timed functionality that is implemented by default in StdDraw. Nothing else is added or removed, i.e. you can use
 *  the very same timed approach as the original implementation also provides. Using listeners is recommended though.
 *  </p>
 *
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static java.util.List<KeyListener> keyListeners = new ArrayList<>();
    private static java.util.List<MouseListener> mouseListeners = new ArrayList<>();
    private static java.util.List<MouseMotionListener> mouseMotionListeners = new ArrayList<>();

    /**
     * Adds the specified {@link java.awt.event.KeyListener} to receive key events from this component.
    ...
    /**
     * Adds the specified {@link java.awt.event.KeyListener} to receive mouse events from this component.
     * If l is null, no exception is thrown and no action is performed.
     *
     * @param l
     */
    ...
    /**
     * Adds the specified {@link java.awt.event.MouseMotionListener} to receive mouse motion events from this component.
     * If l is null, no exception is thrown and no action is performed.
     *
     * @param l
     */
     ...
     * This method performs no function, nor does it throw an exception, if the listener specified by the argument was
     * not previously added to this component. If listener l is null, no exception is thrown and no action is performed.
     *
     * @param l
     */
    ...
    /**
     * Removes the specified {@link java.awt.event.MouseListener} so that it no longer receives mouse events from this component.
     * This method performs no function, nor does it throw an exception, if the listener specified by the argument was
     * not previously added to this component. If listener l is null, no exception is thrown and no action is performed.
     *
     * @param l
    ...
    /**
     * Removes the specified {@link java.awt.event.MouseMotionListener} so that it no longer receives mouse motion events from this component.
     * This method performs no function, nor does it throw an exception, if the listener specified by the argument was
     * not previously added to this component. If listener l is null, no exception is thrown and no action is performed.
     *
     * @param l
    ...
    public void keyTyped(KeyEvent e) {
        synchronized (keyLock) {
            ...
            notifyKeyTypedListeners(e);
        }
    }

    private void notifyKeyTypedListeners(KeyEvent e) {
    ...
    public void keyPressed(KeyEvent e) {
        synchronized (keyLock) {
            ...
            notifyKeyPressedListeners(e);
        }
    }

    private void notifyKeyPressedListeners(KeyEvent e) {
        for (KeyListener l : keyListeners) {
            l.keyPressed(e);
        }
    }
    ...
    public void keyReleased(KeyEvent e) {
        synchronized (keyLock) {
            ...
            notifyKeyReleasedListeners(e);
        }
    }

    private void notifyKeyReleasedListeners(KeyEvent e) {
        for (KeyListener l : keyListeners) {
            l.keyReleased(e);
        }
    }
